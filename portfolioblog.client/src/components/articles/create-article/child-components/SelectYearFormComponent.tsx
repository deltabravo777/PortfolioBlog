...
const SelectYearFormComponent = ({ mainInterface, setMainInterface }:
    ...
    const handleYearFormChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        setMainInterface(prevState => {
            ...
            if (copyMain.newArticleObject?.newArticle) {
                copyMain.newArticleObject.newArticle.year = numberValue;  // Set the casted number
            }
                ...
                <div className="col-auto">
                    <div className="input-group mb-2">
                        ...
                        <input
                            ...
                            value={mainInterface.newArticleObject?.newArticle?.year || ''}
...
export default SelectYearFormComponent;
