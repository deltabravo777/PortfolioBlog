...
const CreateTitleFormComponent = ({ mainInterface, setMainInterface }:
    ...
    const handleTitleFormChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        setMainInterface(prevState => {
            ...
            if (copyMain.newArticleObject.newArticle) {
                copyMain.newArticleObject.newArticle.title = newValue;
            }
...
export default CreateTitleFormComponent;