...
const EditRankFormComponent = ({ mainInterface, setMainInterface }:
    ...
    const handleRankFormChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        setMainInterface(prevState => {
            ...
            if (copyMain.editorObject?.editingArticle) {
                copyMain.editorObject.editingArticle.rank = numberValue;  // Set the casted number
            }
                ...
                <div className="col-auto">
                    <div className="input-group mb-2">
                        ...
                        <input
                            ...
                            value={mainInterface.editorObject?.editingArticle?.rank || ''}
...
export default EditRankFormComponent;
