...
const FileEditComponent = ({ mainInterface, setMainInterface }:
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                setMainInterface(prevState => {
                    ...
                    //}
                    if (copyMain.editorObject.articleEditMode == ArticleEditMode.article) {
                        if (copyMain.editorObject.editingArticle) {
                            copyMain.editorObject.editingArticle.photoPath = result.fileName;
                        }
                        //copyMain.newArticleObject.newArticle.photoPath = result.fileName; // Update photoPath with the returned filename
                    }
                    return copyMain;
