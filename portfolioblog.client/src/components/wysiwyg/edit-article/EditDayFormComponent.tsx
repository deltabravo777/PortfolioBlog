...
const EditDayFormComponent = ({ mainInterface, setMainInterface }:
    ...
    const handleDayFormChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        setMainInterface(prevState => {
            ...
            if (copyMain.editorObject?.editingArticle) {
                copyMain.editorObject.editingArticle.day = numberValue;  // Set the casted number
            }
                ...
                <div className="col-auto">
                    <div className="input-group mb-2">
                        ...
                        <input
                            ...
                            value={mainInterface.editorObject?.editingArticle?.day || ''}
...
export default EditDayFormComponent;
